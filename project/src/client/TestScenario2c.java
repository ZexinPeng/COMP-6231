...
public class TestScenario2c {
    ...
    static class Thread1 implements Runnable{
        ...
        public void run() {
            Client client = new Client();
            client.initialClient(new String[]{}, Location.DDO.toString(), 1);
            String logMessage = client.serverImpl.transferRecord(client.managerID, "TR00004", Location.LVL.toString());
    ...
    static class Thread2 implements Runnable{
        ...
        public void run() {
            Client client = new Client();
            client.initialClient(new String[]{}, Location.DDO.toString(), 2);
            String logMessage = client.serverImpl.transferRecord(client.managerID, "TR00004", Location.LVL.toString());
            client.generateLog(logMessage);
        }
    }
    ...
    static class Thread3 implements Runnable{
        ...
        public void run() {
            Client client = new Client();
            client.initialClient(new String[]{}, Location.DDO.toString(), 3);
            String logMessage = client.serverImpl.transferRecord(client.managerID, "TR00004", Location.LVL.toString());
            client.generateLog(logMessage);
        }
    }
