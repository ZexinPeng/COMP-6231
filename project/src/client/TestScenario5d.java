...
public class TestScenario5d {
    public static void main(String[] args) {
        ...
        client.generateLog(client.serverImpl.transferRecord(client.managerID, "TR00005", Location.DDO.toString()));
        System.out.println(client.serverImpl.getRecordCounts(client.managerID));
    }
    ...
    static class editThread1 implements Runnable{
        ...
        public void run() {
            ...
            String logMessage = client.serverImpl.editRecord("TR00005", "address", "threadA", client.managerID);
    ...
    static class editThread2 implements Runnable{
        ...
        public void run() {
            ...
            String logMessage = client.serverImpl.editRecord("TR00005", "address", "threadB", client.managerID);
            client.generateLog(logMessage);
        }
    }
    ...
    static class editThread3 implements Runnable{
        ...
        public void run() {
            ...
            String logMessage = client.serverImpl.editRecord("TR00005", "address", "threadC", client.managerID);
            client.generateLog(logMessage);
        }
    }
}
