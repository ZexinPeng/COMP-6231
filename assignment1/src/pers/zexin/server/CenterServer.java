...
import pers.zexin.bean.StudentRecord;
...
public interface CenterServer extends Remote {
    ...
    StudentRecord createSRecord(String firstName, String lastName, String[] courseRegistered, String status, String statusDate, Manager manager) throws java.rmi.RemoteException;
    /*
    ...
    String editRecord(String recordID, String fieldName, String newValue, Manager manager) throws java.rmi.RemoteException;
}
