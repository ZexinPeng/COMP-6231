...
public class TestScenario2e {
    public static void main(String[] args) {
        ...
        Thread a = new Thread(new TestScenario2d.editThread1());
        Thread b = new Thread(new TestScenario2d.editThread2());
        Thread c = new Thread(new TestScenario2d.editThread3());
        a.start();
        b.start();
        c.start();
