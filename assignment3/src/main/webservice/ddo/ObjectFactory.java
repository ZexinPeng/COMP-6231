 ...
 * generated in the main.webservice.ddo package. 
...
public class ObjectFactory {
    ...
    private final static QName _EditRecord_QNAME = new QName("http://server.main/", "editRecord");
    private final static QName _GetRecordCountsResponse_QNAME = new QName("http://server.main/", "getRecordCountsResponse");
    private final static QName _CreateSRecord_QNAME = new QName("http://server.main/", "createSRecord");
    private final static QName _CreateSRecordResponse_QNAME = new QName("http://server.main/", "createSRecordResponse");
    private final static QName _GetRecordCounts_QNAME = new QName("http://server.main/", "getRecordCounts");
    private final static QName _CreateTRecord_QNAME = new QName("http://server.main/", "createTRecord");
    private final static QName _TransferRecordResponse_QNAME = new QName("http://server.main/", "transferRecordResponse");
    private final static QName _EditRecordResponse_QNAME = new QName("http://server.main/", "editRecordResponse");
    private final static QName _CreateTRecordResponse_QNAME = new QName("http://server.main/", "createTRecordResponse");
    private final static QName _TransferRecord_QNAME = new QName("http://server.main/", "transferRecord");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: main.webservice.ddo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "editRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "getRecordCountsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "createSRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "createSRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "getRecordCounts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "createTRecord")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "transferRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "editRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "createTRecordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.main/", name = "transferRecord")
