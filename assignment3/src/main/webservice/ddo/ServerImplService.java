 ...
 * 
 */
@WebServiceClient(name = "ServerImplService", targetNamespace = "http://com.zexin", wsdlLocation = "http://localhost:8890/DDOServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8890/DDOServer?wsdl");
